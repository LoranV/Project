...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->panel1->Location = System::Drawing::Point(215, 12);
...
private: System::Void bunifuThinButton23_Click(System::Object^ sender, System::EventArgs^ e) {
	try
	{
		...
		MySqlCommand^ cmd = gcnew MySqlCommand("select * from reg_info where Login='" + username + "' and Password='" + password + "';", con);
		MySqlDataReader^ dr;
